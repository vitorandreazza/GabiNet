        ...
        .when("/cidadaos", {
            ...
            resolve: {
                cidadaos: function (cidadaoAPI, $cookies) {
                    return cidadaoAPI.getCidadaos($cookies.get('idPai'));
                }
            }
        })
        .when("/cidadaos/novo", {
        ...
        .when("/cidadaos/alterar/:id", {
            ...
            resolve: {
                cidadao: function (cidadaoAPI, $route, $cookies) {
                    return cidadaoAPI.getCidadao($route.current.params.id, $cookies.get('idPai'));
                }
            }
        })
        .when("/cidadaos/:id", {
        ...
        .when("/atendimentos", {
            ...
            resolve: {
                atendimentos: function (atendimentoAPI, $cookies) {
                    return atendimentoAPI.getAtendimentos($cookies.get('idPai'));
                }
            }
        })
        ...
        .when("/atendimentos/alterar/:id", {
            ...
            resolve: {
                atendimento: function (atendimentoAPI, $route, $cookies) {
                    return atendimentoAPI.getAtendimento($route.current.params.id, $cookies.get('idPai'));
                }
            }
        })
        ...
        .when("/atividades", {
            ...
            resolve: {
                atividades: function (atividadeAPI, $cookies) {
                    return atividadeAPI.getAtividades($cookies.get('idPai'));
                }
            }
        })
        ...
        .when("/atividades/alterar/:id", {
            ...
            resolve: {
                atividade: function (atividadeAPI, $cookies, $route) {
                    return atividadeAPI.getAtividade($route.current.params.id, $cookies.get('idPai'));
                }
            }
        })
        .when("/atividades/:id", {
